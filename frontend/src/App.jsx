...
function App() {
  ...
  /* Contexte en attente quand on passe par l'aiguillage depuis WeekDetail */
  ...
  /** Inscription depuis WeekDetail : stocke le contexte créneau et passe par l'aiguillage */
  ...
  /** Retour depuis le formulaire vers la page précédente */
