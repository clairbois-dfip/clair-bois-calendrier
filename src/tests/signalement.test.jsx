...
describe('FormulaireSignalement — soumission', () => {
  // Force le mode démo : sans VITE_PA_HTTP_URL, le composant simule l'envoi
  // (sinon un .env.local local déclenche un vrai fetch qui échoue en jsdom)
  beforeEach(() => vi.stubEnv('VITE_PA_HTTP_URL', ''))
