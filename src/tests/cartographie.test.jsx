...
// TODO Phase 3 (PLAN-ACTION-JUILLET-2026.md) — tests écrits pour l'ancienne carto
// « 6 plans mockés » alors que le composant charge désormais les 9 plans réels de
// carto.json. À réécrire lors du passage aux codes TypePlace techniques (Q8),
// qui modifiera de toute façon TYPE_SP_TO_CODE et les libellés testés ici.
// ──────────────────────────────────────────────
// Tests — Vue d'ensemble
// ──────────────────────────────────────────────

describe.skip("Cartographie — vue d'ensemble", () => {
...
describe.skip('Cartographie — navigation', () => {
...
describe.skip('Cartographie — places', () => {
...
describe.skip('Cartographie — educatif', () => {
