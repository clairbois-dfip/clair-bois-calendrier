/**
 * Footer.jsx — Pied de page statique du site.
 * Coherent visuellement avec clairbois.ch : fond sombre (#434343), texte clair.
 * Aucune donnee dynamique : contenu en dur, pas de props necessaires.
 */
export default function Footer() {
  return (
    <footer className="bg-[#434343] text-gray-300 mt-12">
      <div className="max-w-5xl mx-auto px-4 py-6">
        {/* Trois colonnes : coordonnees, foyers/ecoles, entreprises sociales */}
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          <div>
            ...
            {/* Lien externe : rel="noopener noreferrer" pour securite sur target="_blank" */}
            <a
