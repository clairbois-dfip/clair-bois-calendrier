 ...
 * Le seuil de 7 jours est necessaire pour permettre au traitement interne
 * de valider la demande avant le debut du module.
 * @param {Object} semaine - objet semaine avec dateDebut (format "YYYY-MM-DD")
...
export default function ModulesMetiers({ modulesMetiers, onBack, onGoToFormulaire }) {
  ...
  /**
   * Clic sur un module dans la grille.
   * Deselecte si deja choisi, sinon ajoute jusqu'a maxSelection.
   * On bloque aussi si aucune semaine n'est encore choisie (selectedWeek null).
   */
