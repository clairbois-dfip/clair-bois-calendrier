 ...
 *
 * Place dans le parcours : premiere etape quand pourQui === "autre".
 * Affichee uniquement quand c'est un tiers (enseignant, educateur, etc.)
 * qui inscrit le stagiaire a sa place, pas le stagiaire lui-meme.
 *
 * Ces coordonnees deviennent le contact principal pour la fondation
 * tout au long du suivi du dossier.
 *
 * Champs :
 *   - Organisation/Partenaire → etablissement d'origine du referent
 *   - Nom, Prenom             → identification de la personne responsable
 *   - Tel, Email              → moyens de contact directs
 *   - Fonction                → determine le role dans le suivi (education, AI, etc.)
 */
