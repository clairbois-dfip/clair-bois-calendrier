 ...
 *
 * Place dans le parcours : derniere etape avant le recapitulatif et l'envoi.
 * Deux cases obligatoires sans lesquelles la soumission est bloquee :
 *   1. Lecture de la charte anti-abus (obligation legale de la fondation)
 *   2. Engagement a renvoyer la declaration signee par email
 *
 * Les cases utilisent une valeur string "Oui"/""  plutot qu'un booleen
 * pour rester coherentes avec le reste du schema de donnees du formulaire
 * (toutes les valeurs sont des strings pour l'envoi Power Automate).
 */
    ...
    <div className="space-y-5">
      ...
      <div className="space-y-4">
        <label className="flex items-start gap-3 cursor-pointer group">
          {/* Conversion booleen → string "Oui" pour uniformite avec le reste du schema */}
          <input
            type="checkbox"
