/**
 * Confirmation.jsx — Ecran terminal affiche apres la tentative de soumission.
 *
 * Props :
 *   result    : 'success' | 'error'
 *   onGoHome  : rappele pour retourner a l'accueil (les deux cas)
 *   onRetry   : rappele pour revenir au recapitulatif et retenter l'envoi (cas erreur uniquement)
 */
