 ...
 *
 * Place dans le parcours : apres l'etape AI, avant les infos complementaires.
 * La curatelle est une mesure de protection legale ; si elle est active,
 * le curateur doit etre implique dans toute decision concernant le stagiaire.
 * La fondation a besoin de ses coordonnees pour les communications officielles.
 *
 * Logique conditionnelle :
 *   - sous_curatelle = "Non"               → message vert, aucun champ supplementaire
 *   - sous_curatelle = "Oui" ou "curateur complete" → bloc coordonnees du curateur
 *   - pourQui = "autre"                    → option "curateur complete" disponible
 *     car le curateur peut etre la personne qui remplit le formulaire lui-meme
 */
...
export default function EtapeCuratelle({ data, errors, onChange, onBlur, pourQui = 'moi' }) {
  // Quand c'est un referent (pas le stagiaire), on propose l'option
  // ou c'est le curateur lui-meme qui complete le formulaire
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Bloc curateur : les deux valeurs "Oui" declenchent l'affichage,
          car dans les deux cas la fondation a besoin des coordonnees */}
