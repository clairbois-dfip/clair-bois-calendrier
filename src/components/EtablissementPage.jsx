    ...
    <div className="animate-fadeIn">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        {etablissement.secteurs.map((secteur) => {
          // Sans deduplication, un creneau chevauchant deux semaines serait compte deux fois
          ...
          // Statut calcule localement (pas dans les donnees JSON) pour eviter la desynchronisation
